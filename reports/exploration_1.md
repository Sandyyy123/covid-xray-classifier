...
**Project:** Liora 08 - Analysis of COVID-19 chest X-rays
**Date:** 2026-05-01
...
- Local archive: `/root/AI/liora_projects/08_covid_xrays/data/covid_xrays_archive.zip` (~29 GB on disk; the brief lists 1.15 GB which corresponds to the v3 release, so this archive is the expanded v5 release with 4 classes plus segmentation masks).
